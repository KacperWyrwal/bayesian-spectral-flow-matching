...
class dummy_mlp(torch.nn.Module):
    def __init__(self, model_config):
        ...
        self.linear1 = torch.nn.Linear(in_dim, model_config.intermediate_dim)
        self.linear2 = torch.nn.Linear(model_config.intermediate_dim, model_config.intermediate_dim)
        self.linear3 = torch.nn.Linear(model_config.intermediate_dim, model_config.output_dim)
        self.linear4 = torch.nn.Linear(model_config.output_dim, 1)
